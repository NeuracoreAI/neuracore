...
from neuracore.core.data.prefetch import DEFAULT_INFLIGHT_REQUESTS, VideoPrefetcher
...
class SynchronizedDataset:
    ...
    def __init__(
        ...
        self._prefetch_inflight_requests = prefetch_inflight_requests
    ...
    def _perform_synced_data_prefetch(self) -> None:
        ...
        prefetcher = VideoPrefetcher(
            ...
            inflight_requests=self._prefetch_inflight_requests,
            decode_workers=self._max_prefetch_workers,
    ...
    def __getitem__(
        ...
        if isinstance(idx, slice):
            ...
            return SynchronizedDataset(
                ...
                prefetch_inflight_requests=self._prefetch_inflight_requests,
