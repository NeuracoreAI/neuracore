...
class Dataset:
    ...
    def _request_recordings_page(
        ...
        Args:
            ...
            direction: "backward" to start from the oldest recording and
                page toward newer ones. Omitted (or "forward") starts from
                the newest recording and pages toward older ones — the
                backend defaults an absent direction to forward.
