...
from neuracore.core.robot import list_robots
...
class Dataset:
    ...
    def _robot_id_to_name(
        ...
        """
        shared_robots = list_robots(org_id=self.org_id, is_shared=True, mode="mixed")
        private_robots = list_robots(org_id=self.org_id, is_shared=False, mode="mixed")
