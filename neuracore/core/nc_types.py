...
class DataItemStats(BaseModel):
    ...
    standard deviations, counts, min, max, and maximum lengths for normalization
    ...
    Attributes:
        ...
        min: List of min for each data dimension
        max: List of max for each data dimension
