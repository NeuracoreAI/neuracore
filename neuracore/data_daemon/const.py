...
CONTROL_SOCKET_PATH = BASE_DIR / "control.sock"
DEFAULT_JSON_SOCKET_PATH = BASE_DIR / "json_default.sock"
CUSTOM_1D_SOCKET_PATH = BASE_DIR / "custom_1d.sock"
POSES_SOCKET_PATH = BASE_DIR / "poses.sock"
END_EFFECTOR_POSES_SOCKET_PATH = BASE_DIR / "end_effector_poses.sock"
PARALLEL_GRIPPER_OPEN_AMOUNTS_SOCKET_PATH = BASE_DIR / "parallel_gripper_open_amounts.sock"
PARALLEL_GRIPPER_TARGET_OPEN_AMOUNTS_SOCKET_PATH = BASE_DIR / "parallel_gripper_target_open_amounts.sock"
LANGUAGE_SOCKET_PATH = BASE_DIR / "language.sock"
POINT_CLOUDS_SOCKET_PATH = BASE_DIR / "point_clouds.sock"
JOINT_POSITIONS_SOCKET_PATH = BASE_DIR / "joint_positions.sock"
JOINT_VELOCITIES_SOCKET_PATH = BASE_DIR / "joint_velocities.sock"
JOINT_TORQUES_SOCKET_PATH = BASE_DIR / "joint_torques.sock"
VISUAL_JOINT_POSITIONS_SOCKET_PATH = BASE_DIR / "visual_joint_positions.sock"
VIDEO_SOCKET_PATH = BASE_DIR / "video_management.sock"
TRANSPORT_GROUP_SOCKET_PATHS = {
    "default_json": DEFAULT_JSON_SOCKET_PATH,
    "custom_1d": CUSTOM_1D_SOCKET_PATH,
    "poses": POSES_SOCKET_PATH,
    "end_effector_poses": END_EFFECTOR_POSES_SOCKET_PATH,
    "parallel_gripper_open_amounts": PARALLEL_GRIPPER_OPEN_AMOUNTS_SOCKET_PATH,
    "parallel_gripper_target_open_amounts": PARALLEL_GRIPPER_TARGET_OPEN_AMOUNTS_SOCKET_PATH,
    "language": LANGUAGE_SOCKET_PATH,
    "point_clouds": POINT_CLOUDS_SOCKET_PATH,
    "joint_positions": JOINT_POSITIONS_SOCKET_PATH,
    "joint_velocities": JOINT_VELOCITIES_SOCKET_PATH,
    "joint_torques": JOINT_TORQUES_SOCKET_PATH,
    "visual_joint_positions": VISUAL_JOINT_POSITIONS_SOCKET_PATH,
}
ALL_SOCKET_PATHS = (
    SOCKET_PATH,
    CONTROL_SOCKET_PATH,
    DEFAULT_JSON_SOCKET_PATH,
    CUSTOM_1D_SOCKET_PATH,
    POSES_SOCKET_PATH,
    END_EFFECTOR_POSES_SOCKET_PATH,
    PARALLEL_GRIPPER_OPEN_AMOUNTS_SOCKET_PATH,
    PARALLEL_GRIPPER_TARGET_OPEN_AMOUNTS_SOCKET_PATH,
    LANGUAGE_SOCKET_PATH,
    POINT_CLOUDS_SOCKET_PATH,
    JOINT_POSITIONS_SOCKET_PATH,
    JOINT_VELOCITIES_SOCKET_PATH,
    JOINT_TORQUES_SOCKET_PATH,
    VISUAL_JOINT_POSITIONS_SOCKET_PATH,
    VIDEO_SOCKET_PATH,
)
