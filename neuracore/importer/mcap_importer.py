...
from neuracore.importer.core.validation import JOINT_DATA_TYPES
...
class MCAPDatasetImporter(NeuracoreDatasetImporter):
    ...
    def _prepare_log_data(
        ...
        """Validate and transform source data for MCAP cache preprocessing.

        Simpler than the base _log_data path: no IK/FK since MCAP messages
        are already decoded from ROS types by the time this is called.
        """
        try:
