...
def _serialize_robot_data_spec(
    ...
    serializable: CrossEmbodimentDescription = {}
...
def run_training(
    ...
    cfg: DictConfig,
    batch_size: int,
    input_cross_embodiment_description: dict[str, dict[DataType, list[str]]],
    output_cross_embodiment_description: dict[str, dict[DataType, list[str]]],
...
def main(cfg: DictConfig) -> None:
    ...
    cross_embodiment_union: dict[str, dict[DataType, list[str]]] = (
        merge_cross_embodiment_description(
            input_cross_embodiment_description, output_cross_embodiment_description
        )
    )
