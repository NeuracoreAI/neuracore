...
class PytorchNeuracoreDataset(Dataset, ABC):
    ...
    def _collate_input_outputs(
        ...
        [
            {
                DataType.JOINTS: [BatchedJointData, BatchedJointData, ...],
                DataType.CAMERA: [BatchedCameraData, ...],
                ...
            },
            ...
        ]
        ...
        {
            DataType.JOINTS: [BatchedJointData, ...],
            DataType.CAMERA: [BatchedCameraData, ...],
            ...
        }
            ...
            for item_idx in range(num_items):
                ...
                for attr_name in attrib_names_of_tensors:
                    ...
                    if attr_values[0] is not None:
                        batched_attributes[attr_name] = torch.stack(attr_values, dim=0)
                    else:
