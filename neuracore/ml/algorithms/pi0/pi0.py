...
# Login to Hugging Face to access paligemma model (replace with your own token)
# login(token="hf_XXXXXXXXXX")

PI_TINY_ARGS = {
    "vlm_expert_width": 2048,
    "vlm_expert_intermediate_size": 512,
    "vlm_expert_num_heads": 8,
    "vlm_expert_head_dim": 128,
    "action_expert_width": 2048,
    "action_expert_intermediate_size": 512,
    "action_expert_num_heads": 8,
    "action_expert_head_dim": 128,
    "moe_depth": 4,
}
...
class Pi0(NeuracoreModel):
    ...
    def __init__(
        ...
        Args:
            ...
            vlm_backbone: Backbone model for the VLM.
            vlm_expert_width: Width of the VLM expert.
        ...
        self.vlm_max_tokens = 2 * 256 + self.vlm_max_text_tokens  # default 2 cameras
    ...
    def _load_pretrained_vlm_weights(self) -> None:
        ...
        print("Loading pretrained PaliGemma weights into VLM expert...")
        ...
        print("Successfully loaded pretrained PaliGemma weights into VLM expert.")
