...
setup(
    ...
    package_data={
        ...
        "neuracore.core.streaming.p2p": [
            # Pre-built neuracore_webrtc cdylib (the Rust WebRTC streaming
            # core). Generated by the same build script, gitignored, and gated
            # at runtime by NCD_RUST_WEBRTC; absent from a plain checkout.
            "_native_webrtc.so",
        ],
    },
    version=version,
