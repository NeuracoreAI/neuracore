...
def pytest_configure(_config: pytest.Config) -> None:  # noqa: ARG001
    """Configure logging to ensure warnings are captured."""
    logging.getLogger(
        "tests.integration.platform.data_daemon.shared.process_control"
