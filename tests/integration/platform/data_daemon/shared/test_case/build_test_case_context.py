...
STOCHASTIC_BUSY_WAIT = os.getenv("NEURACORE_STOCHASTIC_BUSY_WAIT", "1") == "1"
...
def log_synchronous_frames(
    *,
    ...
    """
    preallocate_frame_buffer(bool(camera_name_list), image_width, image_height)
    ...
    while joint_index < joint_frame_count or video_index < (
        ...
        if joint_deadline <= video_deadline:
            ...
            if remaining > 0:
                history.wait(
                    remaining,
                    busy_wait=(use_stochastic_timestamps and STOCHASTIC_BUSY_WAIT),
                    role_name=role_name,
                    frame_index=joint_index,
                    deadline=joint_deadline,
                )
    ...
    *,
    ...
    def worker(role_spec: dict[str, object]) -> None:
        ...
        try:
            ...
            preallocate_frame_buffer(is_rgb, image_width, image_height)
