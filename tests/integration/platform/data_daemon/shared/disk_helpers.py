...
def assert_disk_recording_properties(
    ...
    for result in results:
        ...
        # On-disk recordings are keyed by the daemon-assigned integer
        # recording_index (Rust) or the cloud recording_id (legacy); that same
        # key names the top directory segment, the traces join key, and the
