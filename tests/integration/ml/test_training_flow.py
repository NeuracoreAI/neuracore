...
# EXISTING_PRIVATE_DATASET_NAME = "Transfer Cube VX300s Dataset"
...
OUTPUT_DATA_SPEC = {
    DataType.JOINT_TARGET_POSITIONS: list(BimanualViperXTask.ACTION_KEYS),
}
...
def _run_policy_inference(policy: Policy) -> None:
    try:
        ...
        assert DataType.JOINT_TARGET_POSITIONS in predictions, (
            "Expected JOINT_TARGET_POSITIONS in local "
