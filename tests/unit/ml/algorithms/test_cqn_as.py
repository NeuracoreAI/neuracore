...
def pytorch_dummy_dataset() -> PytorchDummyDataset:
    input_data_types = CQN_AS.get_supported_input_data_types()
    output_data_types = CQN_AS.get_supported_output_data_types()
...
def test_model_backward(
    ...
    # Note: critic_target parameters don't receive gradients (updated via soft updates)
    for name, param in model.named_parameters():
        if param.requires_grad and "critic_target" not in name:
