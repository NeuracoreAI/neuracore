...
def test_nc_dataset_clone_from_dataset_object(
    temp_config_dir,
    mock_data_requests,
    reset_neuracore,
    dataset_response,
    ...
    cloned = nc.dataset_clone("clone", dataset=source)
...
def test_nc_dataset_clone_from_dataset_id(
    temp_config_dir,
    mock_data_requests,
    reset_neuracore,
    dataset_response,
    ...
    cloned = nc.dataset_clone("clone", dataset_id="source_dataset")

    assert cloned.id == "cloned_dataset"
    assert mock_data_requests.last_request.json()["sourceDatasetId"] == "source_dataset"


def test_nc_dataset_clone_from_dataset_name(
    temp_config_dir,
    mock_data_requests,
    reset_neuracore,
    dataset_response,
    ...
    cloned = nc.dataset_clone(dataset_name="source_name", new_dataset_name="clone")

    assert cloned.id == "cloned_dataset"
    assert mock_data_requests.last_request.json()["sourceDatasetId"] == "dataset_123"


def test_nc_dataset_clone_missing_source_raises(
    temp_config_dir,
    mock_data_requests,
    reset_neuracore,
    mocked_org_id,
    ...
    with pytest.raises(DatasetError, match="Dataset 'missing' not found"):
        nc.dataset_clone("clone", dataset_name="missing")


def test_nc_dataset_clone_api_error(
    temp_config_dir,
    mock_data_requests,
    reset_neuracore,
    mocked_org_id,
    ...
    with pytest.raises(
        ...
        nc.dataset_clone("clone", dataset=source)
